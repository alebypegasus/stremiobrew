// webOS service for io.strem.tv.adapted. Runs under the TV's service Node runtime.
...
function startSupervisor() {
  ...
  dbg('spawning supervisor: ' + LOADER + ' ' + NODE + ' ' + SUPERVISOR + ' ' + APP_PORT);
  var child;
  try {
    child = spawn(LOADER, ['--library-path', LIB, NODE, SUPERVISOR, String(APP_PORT)], {
